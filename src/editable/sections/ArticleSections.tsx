  ...
  return (
    <main className={dc.shell.page}>
      <section className={`${dc.shell.section} pt-12 sm:pt-16 lg:pt-20`}>
        <div className={`rounded-lg border ${pal.border} ${pal.darkBg} p-6 text-white shadow-[0_18px_55px_rgba(24,20,17,0.16)] sm:p-8 lg:p-10`}>
  ...
  return (
    <main className={dc.shell.page}>
      <section className={`${dc.shell.section} pt-10 sm:pt-14 lg:pt-16`}>
        <div className={`grid gap-6 rounded-lg border ${pal.border} bg-white p-6 shadow-[0_18px_55px_rgba(24,20,17,0.08)] lg:grid-cols-[minmax(0,1fr)_320px] lg:p-10`}>
      ...
      <section className="mx-auto w-full max-w-5xl px-4 pb-16 pt-6 sm:px-6 lg:px-8 lg:pb-24">
        <div className={`rounded-lg border ${pal.border} bg-white p-6 shadow-[0_18px_55px_rgba(24,20,17,0.08)] sm:p-8 lg:p-10`}>
