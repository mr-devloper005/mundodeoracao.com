...
const inputClass = 'h-12 rounded-md border border-[var(--editable-border)] bg-white px-4 text-base font-bold text-current outline-none transition placeholder:text-current/35 focus:border-[var(--slot4-accent)]'
const buttonClass = 'inline-flex h-12 items-center justify-center rounded-md bg-[var(--slot4-dark-bg)] px-6 text-sm font-black uppercase tracking-[0.16em] text-white transition hover:-translate-y-0.5 disabled:opacity-60'
