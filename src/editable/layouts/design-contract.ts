...
export const editableRootStyle = {
  '--slot4-page-bg': '#f6f2ea',
  '--slot4-page-text': '#17202a',
  '--slot4-panel-bg': '#ffffff',
  '--slot4-surface-bg': '#ffffff',
  '--slot4-muted-text': '#56616d',
  '--slot4-soft-muted-text': '#6d7782',
  '--slot4-accent': '#0e7490',
  '--slot4-accent-fill': '#0e7490',
  '--slot4-accent-soft': '#e7f6f8',
  '--slot4-dark-bg': '#17202a',
  '--slot4-dark-text': '#ffffff',
  '--slot4-media-bg': '#e5edf0',
  '--slot4-cream': '#f6f2ea',
  '--slot4-warm': '#fbfaf6',
  '--slot4-lavender': '#eef7f8',
  '--slot4-gray': '#f3f5f6',
  '--slot4-body-gradient': 'linear-gradient(180deg, #f6f2ea 0%, #fbfaf6 42%, #f3f5f6 100%)',
} as CSSProperties
...
export const editableDesignContract = {
  ...
  type: {
    ...
    heroTitle: 'text-4xl font-extrabold leading-[1.08] tracking-tight sm:text-5xl lg:text-[3.15rem]',
